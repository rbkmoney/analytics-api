...
get_webhooks(Context) ->
    {Url, PreparedParams, Opts} = yapi_client_lib:make_request(Context, #{}),
...
create_webhook(Context, Params) ->
    {Url, PreparedParams, Opts} = yapi_client_lib:make_request(Context, #{body => Params}),
