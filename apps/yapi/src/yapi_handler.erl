...
get_handlers() ->
    [
        yapi_handler_accounts,
        yapi_handler_analytics,
        yapi_handler_categories,
        yapi_handler_claims,
        yapi_handler_contracts,
        yapi_handler_customers,
        yapi_handler_geo,
        yapi_handler_invoice_templates,
        yapi_handler_invoices,
        yapi_handler_parties,
        yapi_handler_payment_institutions,
        yapi_handler_payments,
        yapi_handler_payouts,
        yapi_handler_reports,
        yapi_handler_search,
        yapi_handler_shops,
        yapi_handler_tokens,
        yapi_handler_webhooks
    ].
...
handle_request(OperationID, Req, SwagContext = #{auth_context := AuthContext}, _HandlerOpts) ->
    ...
    try
        case yapi_auth:authorize_operation(OperationID, Req, AuthContext) of
            ok ->
...
collect_user_identity(AuthContext) ->
    genlib_map:compact(#{
        id       => yapi_auth:get_subject_id(AuthContext),
        realm    => ?REALM,
        email    => yapi_auth:get_claim(<<"email">>, AuthContext, undefined),
        username => yapi_auth:get_claim(<<"name">> , AuthContext, undefined)
    }).

attach_deadline(#{'X-Request-Deadline' := undefined}, Context) ->
    Context;
attach_deadline(#{'X-Request-Deadline' := Header}, Context) ->
    case yapi_utils:parse_deadline(Header) of
