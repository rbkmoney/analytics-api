-module(yapi_handler_decoder_utils).
...
-spec decode_currency(yapi_handler_encoder:encode_data()) ->
    binary().
...
-spec decode_business_schedule_ref(yapi_handler_encoder:encode_data()) ->
    binary() | undefined.
...
-spec decode_category_ref(yapi_handler_encoder:encode_data()) ->
    integer().

decode_category_ref(#domain_CategoryRef{id = CategoryRef}) ->
    CategoryRef.

-spec decode_context(yapi_handler_encoder:encode_data()) ->
