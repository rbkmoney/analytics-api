...
-spec decode_currency(anapi_handler_encoder:encode_data()) ->
    binary().
...
-spec decode_business_schedule_ref(anapi_handler_encoder:encode_data()) ->
    binary() | undefined.
...
-spec decode_category_ref(anapi_handler_encoder:encode_data()) ->
    integer().
